    ...
    <main className="min-h-screen bg-gray-50">
      <header className="bg-white shadow-sm border-b sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-800">DR Detection System</h1>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border p-6">
          ...
          >
            {preview ? (
              <div>
                <img src={preview} alt="Preview" className="max-h-52 mx-auto rounded-xl object-contain mb-2" />
                <p className="text-xs text-blue-600">Click to change image</p>
              </div>
            ) : (
              <div>
                <p className="text-4xl mb-3">🔬</p>
                <p className="text-gray-600 font-medium">Drop retinal fundus image here</p>
                <p className="text-gray-400 text-sm mt-1">or click to browse — supports JPG, PNG</p>
              </div>
            )}
          </div>
          <input
          ...
          <>
            <div className="bg-white rounded-2xl shadow-sm border p-6">
              ...
              <div className="flex flex-wrap items-center gap-4 mb-5">
                <div className={`px-6 py-3 rounded-2xl border-2 text-lg font-bold ${CLASS_COLORS[result.prediction]}`}>
                  {result.prediction.replace(/_/g, ' ')}
                </div>
                <div>
                  <p className="text-3xl font-bold text-gray-800">{result.confidence.toFixed(1)}%</p>
              ...
              <p className="text-sm font-medium text-gray-500 mb-3">All Class Probabilities:</p>
            ...
            <div className="bg-white rounded-2xl shadow-sm border p-6">
              <h2 className="text-base font-semibold text-gray-700 mb-1">Retinal Image Analysis</h2>
              <p className="text-xs text-gray-400 mb-5">
                Score-CAM (Wang et al. 2020) highlights retinal regions that influenced the prediction — gradient-free XAI.
                Red/yellow = high attention &bull; Blue = low attention

              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <img src={result.original_image} alt="Original" className="w-full rounded-xl border object-cover aspect-square" />
                  <p className="text-xs text-center text-gray-500 mt-2 font-medium">Original Image</p>
                </div>
                <div>
                  <img src={result.clahe_image} alt="CLAHE Enhanced" className="w-full rounded-xl border object-cover aspect-square" />
                  <p className="text-xs text-center text-gray-500 mt-2 font-medium">
                    CLAHE Enhanced <span className="text-gray-400">(Model Input)</span>
                  </p>
                </div>
                <div>
                  <img src={result.gradcam_image} alt="Grad-CAM" className="w-full rounded-xl border object-cover aspect-square" />
                  <p className="text-xs text-center text-gray-500 mt-2 font-medium">
                    Score-CAM Heatmap <span className="text-red-400">🔴 Focus areas</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border p-6">
              <h2 className="text-base font-semibold text-gray-700 mb-1">Download Clinical Report</h2>
              <p className="text-sm text-gray-400 mb-4">
                Generate a PDF with prediction, Grad-CAM heatmap, probabilities and recommendation.
              </p>
              <button
        ...
        <footer className="text-center text-xs text-gray-400 pb-8 space-y-1">
          <p>K.W.I.N. Kariyawasam | Reg. No: 2020/ICT/39 | University of Vavuniya, Department of Physical Science</p>
          <p>⚠️ This system is a research prototype. It should not replace clinical diagnosis by a qualified ophthalmologist.</p>
        </footer>
